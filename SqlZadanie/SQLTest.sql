...
insert into Products values (1,'Мобилка_1'), (2,'Машинка'), (3,'Домик'), (4,'Верблюд'), (5,'Мобилка_2');

insert into Categories values (1,'Телефон'), (2,'Средства связи'), (3,'Автомобили'), (4,'Дома');
...
left join Categories on ProductsAndCategories.CategoryNameId = Categories.Id; /*Наш JOIN*/ 